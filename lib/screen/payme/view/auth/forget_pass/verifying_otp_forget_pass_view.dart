...
class VerifyingOtpForgetPassView extends StatefulWidget {
  final bool otpVerified;

  const VerifyingOtpForgetPassView({super.key, required this.otpVerified});

  @override
  State<VerifyingOtpForgetPassView> createState() =>
      _VerifyingOtpForgetPassViewState();
}

class _VerifyingOtpForgetPassViewState
    extends State<VerifyingOtpForgetPassView> {
  bool isLoading = true;
